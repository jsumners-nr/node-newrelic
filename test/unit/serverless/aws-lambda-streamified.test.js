...
function makeStreamHandler(toDecorate, options = {}) {
  toDecorate[HANDLER_STREAMING] = STREAM_RESPONSE
  if (typeof options?.highWaterMark === 'number') {
    toDecorate[HANDLER_HIGHWATERMARK] = parseInt(options.highWaterMark)
  }
  return toDecorate
}
...
//   const patchedFn = awsLambda.patchLambdaHandler(handler)
//   patchedFn(stubEvent, stubResponseStream, stubContext)
...
test('when invoked with API Gateway Lambda proxy event', async (t) => {
  ...
  //     }
  //
  //     const handler = makeStreamHandler(async (event, responseStream, context) => {
  ...
  await t.test('should capture status code', (t, end) => {
    ...
    const handler = makeStreamHandler(async (event, responseStream, context) => {
      responseStream = HttpsResponseStream.from(responseStream, validStreamMetaData)
...
//
// test('should create a segment for handler', (t, end) => {
...
// })
//
// test('should capture cold start boolean on first invocation', (t, end) => {
//   const { agent, awsLambda, stubEvent, stubResponseStream, stubContext } = t.nr
...
// })
//
// test('should not include cold start on subsequent invocations', (t, end) => {
//   const { agent, awsLambda, stubEvent, stubResponseStream, stubContext } = t.nr
...
// })
//
// test('should capture AWS agent attributes and send to correct dests', (t, end) => {
//   const { agent, awsLambda, stubResponseStream, stubContext } = t.nr
...
// })
//
// test('should not add attributes from empty event', (t, end) => {
//   const { agent, awsLambda, stubEvent, stubResponseStream, stubContext } = t.nr
//   agent.on('transactionFinished', confirmAgentAttribute)
//
//   const handler = lambdaBuiltIns.streamifyResponse(async (event, responseStream, context) => {
...
// })
//
// test('should capture kinesis data stream event source arn', (t, end) => {
//   const { agent, awsLambda, stubResponseStream, stubContext } = t.nr
//   agent.on('transactionFinished', confirmAgentAttribute)
//
...
// })
//
// test('should capture S3 PUT event source arn attribute', (t, end) => {
//   const { agent, awsLambda, stubResponseStream, stubContext } = t.nr
//   agent.on('transactionFinished', confirmAgentAttribute)
//
...
// })
//
// test('should capture SNS event source arn attribute', (t, end) => {
//   const { agent, awsLambda, stubResponseStream, stubContext } = t.nr
//   agent.on('transactionFinished', confirmAgentAttribute)
//
...
// })
//
// test('should capture DynamoDB Update event source attribute', (t, end) => {
//   const { agent, awsLambda, stubResponseStream, stubContext } = t.nr
//   agent.on('transactionFinished', confirmAgentAttribute)
//
...
// })
//
// test('should capture CodeCommit event source attribute', (t, end) => {
//   const { agent, awsLambda, stubResponseStream, stubContext } = t.nr
//   agent.on('transactionFinished', confirmAgentAttribute)
//
...
// })
//
// test('should not capture unknown event source attribute', (t, end) => {
//   const { agent, awsLambda, stubResponseStream, stubContext } = t.nr
//   agent.on('transactionFinished', confirmAgentAttribute)
//
...
// })
//
// test('should capture Kinesis Data Firehose event source attribute', (t, end) => {
//   const { agent, awsLambda, stubResponseStream, stubContext } = t.nr
//   agent.on('transactionFinished', confirmAgentAttribute)
//
...
// })
//
// test('should capture ALB event type', (t, end) => {
//   const { agent, awsLambda, stubResponseStream, stubContext } = t.nr
//   agent.on('transactionFinished', confirmAgentAttribute)
//
...
// })
//
// test('should capture CloudWatch Scheduled event type', (t, end) => {
//   const { agent, awsLambda, stubResponseStream, stubContext } = t.nr
//   agent.on('transactionFinished', confirmAgentAttribute)
//
...
// })
//
// test('should capture SES event type', (t, end) => {
//   const { agent, awsLambda, stubResponseStream, stubContext } = t.nr
//   agent.on('transactionFinished', confirmAgentAttribute)
//
...
// })
//
// test('should capture ALB event type with multi value parameters', (t, end) => {
//   const { agent, awsLambda, stubResponseStream, stubContext } = t.nr
//   agent.on('transactionFinished', confirmAgentAttribute)
//
//   agent.config.attributes.enabled = true
...
// })
//
// test('when callback used', async (t) => {
//   helper.unloadAgent(t.nr.agent)
//
...
// })
//
// test('should create a transaction for handler', (t, end) => {
//   const { agent, awsLambda, stubEvent, stubResponseStream, stubContext } = t.nr
//   const handler = lambdaBuiltIns.streamifyResponse(async (event, responseStream, context) => {
//     const transaction = agent.tracer.getTransaction()
//     assert.ok(transaction)
...
// })
//
// test('should end transactions on a beforeExit event on process', (t, end) => {
//   const { agent, awsLambda, stubEvent, stubResponseStream, stubContext } = t.nr
...
// })
//
// test('should end transactions after the returned promise resolves', (t, end) => {
//   const { agent, awsLambda, stubEvent, stubResponseStream, stubContext } = t.nr
//   let transaction
//
//   const handler = lambdaBuiltIns.streamifyResponse(async (event, responseStream, context) => {
...
// })
//
// test('should record error event when func is async and promise is rejected', (t, end) => {
//   const { agent, awsLambda, error, stubEvent, stubResponseStream, stubContext } = t.nr
//   agent.on('harvestStarted', confirmErrorCapture)
//
//   let transaction
...
// })
//
// test('should record error event when func is async and error is thrown', (t, end) => {
//   const { agent, awsLambda, error, stubEvent, stubResponseStream, stubContext } = t.nr
//   agent.on('harvestStarted', function confirmErrorCapture() {
//     const errors = agent.errors.traceAggregator.errors
//     assert.equal(errors.length, 1)
...
// })
//
// test('should not end transactions twice', (t, end) => {
//   const { agent, awsLambda, stubEvent, stubResponseStream, stubContext } = t.nr
//   let transaction
//
//   const handler = lambdaBuiltIns.streamifyResponse(async (event, responseStream, context) => {
...
// })
//
// test('should record standard background metrics', (t, end) => {
//   const { agent, awsLambda, stubEvent, stubResponseStream, stubContext } = t.nr
//   agent.on('harvestStarted', confirmMetrics)
//
//   const handler = lambdaBuiltIns.streamifyResponse(async (event, responseStream, context) => {
