...
//   console.log('server started', server, hostname, port)
// const req = http.request(
// `http://${hostname}:${port}/foo/bar?baz=foobar`,
// {
//  headers: {
//  'one': ['two', 'three']
// }
...
//   await lambdaHandler({}, responseStream, {})
//
//   console.log('responseDone:', await responseDone)
//   server.close()
// }

// async function lambdaHandler(event, responseStream, context) {
//   responseStream.write(JSON.stringify({ in: 'test' }))
//   responseStream.end()
// }
